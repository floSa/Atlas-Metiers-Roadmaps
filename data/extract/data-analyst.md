# Data Analyst Roadmap — plan extrait

- **Slug** : `data-analyst`
- **Description amont** : Step by step guide to becoming an Data Analyst in @currentYear@
- **Derniere modification amont** : 2026-09-04T06:54:17.861Z
- **Capture** : 2026-09-16
- **Volume** : 99 noeuds de contenu, 99 documentes, 192 ressources
- **Renvois vers d'autres roadmaps** : `https://roadmap.sh`, `https://roadmap.sh/ai-data-scientist`, `https://roadmap.sh/machine-learning`, `https://roadmap.sh/power-bi`, `https://roadmap.sh/python-data-analysis`, `https://roadmap.sh/r-programming`, `https://roadmap.sh/sql`
