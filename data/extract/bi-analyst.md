# BI Analyst — plan extrait

- **Slug** : `bi-analyst`
- **Description amont** : Learn to become a Business Intelligence Analyst in @currentYear@
- **Derniere modification amont** : 2026-09-04T07:05:19.320Z
- **Capture** : 2026-09-16
- **Volume** : 200 noeuds de contenu, 200 documentes, 275 ressources
- **Renvois vers d'autres roadmaps** : `https://roadmap.sh`, `https://roadmap.sh/ai-data-scientist`, `https://roadmap.sh/data-analyst`, `https://roadmap.sh/power-bi`, `https://roadmap.sh/python-data-analysis`, `https://roadmap.sh/r-programming`, `https://roadmap.sh/sql`
