# Computer Science — plan extrait

- **Slug** : `computer-science`
- **Description amont** : Computer Science curriculum with free resources for a self-taught developer.
- **Derniere modification amont** : 2026-09-07T17:52:13.415Z
- **Capture** : 2026-09-16
- **Volume** : 188 noeuds de contenu, 188 documentes, 498 ressources
- **Renvois vers d'autres roadmaps** : `https://roadmap.sh`, `https://roadmap.sh/api-design`, `https://roadmap.sh/cyber-security`, `https://roadmap.sh/datastructures-and-algorithms`, `https://roadmap.sh/leetcode`, `https://roadmap.sh/network-engineer`, `https://roadmap.sh/system-design`
