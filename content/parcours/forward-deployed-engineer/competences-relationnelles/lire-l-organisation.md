...
```mermaid
flowchart TD
  D["Qui décide<br/>le mandat réel, pas l'organigramme"]
  P["Qui paie<br/>le budget et sa logique"]
  U["Qui utilisera<br/>et qui n'a rien demandé"]
  L["Qui perd quelque chose<br/>leur inquiétude est fondée"]
  B["Qui peut bloquer sans décider<br/>sécurité, DPO, achats, exploitation"]

  click D "/notions/gestion-parties-prenantes"
  click P "/notions/roi-des-projets-ia"
  click U "/notions/conduite-du-changement"
  click L "/notions/reingenierie-de-processus"
  click B "/notions/gouvernance-ia"
```
