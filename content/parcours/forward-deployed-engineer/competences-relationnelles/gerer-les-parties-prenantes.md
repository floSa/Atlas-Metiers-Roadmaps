...
```mermaid
flowchart TD
  S["Les sceptiques d'abord<br/>leur objection porte sur un cas précis"]
  P["Des preuves, pas des arguments<br/>le jeu d'évaluation"]
  A["Gérer les attentes avant la démonstration<br/>jamais après"]
  E["Escalader vite et factuellement<br/>le silence coûte trois semaines"]
  H["Un point hebdomadaire écrit<br/>avancé, bloqué, décidé"]

  click S "/notions/gestion-parties-prenantes"
  click P "/notions/evaluation-llm"
  click A "/notions/cadrage-besoin"
  click E "/notions/conduite-du-changement"
  click H "/notions/redaction-technique"
```
