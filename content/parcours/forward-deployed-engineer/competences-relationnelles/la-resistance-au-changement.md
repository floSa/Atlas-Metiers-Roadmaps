...
```mermaid
flowchart TD
  E["La peur pour l'emploi<br/>une réponse honnête, pas un « rassurez-vous »"]
  X["Une expertise dévaluée<br/>la compétence devient moins rare"]
  C["La charge de transition<br/>l'ancien processus et le nouveau, en même temps"]
  M["Le souvenir d'un projet abandonné<br/>ce qui a été tenté avant"]
  D["Un désaccord technique fondé<br/>c'est le cas limite qui manquait"]

  click E "/notions/conduite-du-changement"
  click X "/notions/transfert-de-competences"
  click C "/notions/reingenierie-de-processus"
  click M "/notions/gestion-parties-prenantes"
  click D "/notions/evaluation-llm"
```
