...
```mermaid
flowchart TD
  N["Dire non fait partie du service<br/>en proposant l'alternative"]
  I["Ne pas devenir la dépendance<br/>celui qui règle tout lui-même"]
  L["Loyauté au résultat<br/>pas à un camp"]
  D["Les limites déontologiques<br/>surveillance, base légale, conformité affichée"]
  A["Comprendre comment l'organisation gagne sa vie<br/>avant de proposer quoi que ce soit"]

  click N "/notions/cadrage-besoin"
  click I "/notions/transfert-de-competences"
  click L "/notions/gestion-parties-prenantes"
  click D "/notions/gouvernance-ia"
