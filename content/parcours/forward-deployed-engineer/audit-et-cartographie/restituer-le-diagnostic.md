...
```mermaid
flowchart TD
  O["Les opérationnels d'abord<br/>être corrigé en petit comité"]
  C["Se faire corriger la carte<br/>c'est le but de la séance"]
  D["La direction ensuite<br/>avec une carte déjà validée par le terrain"]
  E["Acter par écrit<br/>ce qui a été reconnu"]

  click O "/notions/conduite-du-changement"
  click C "/notions/bpmn"
