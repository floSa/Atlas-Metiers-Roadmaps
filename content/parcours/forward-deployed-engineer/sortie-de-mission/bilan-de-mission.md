...
```mermaid
flowchart TD
  S["Ce qui est en service et mesuré<br/>par opposition à ce qui est construit"]
  E["Ce qui n'a pas abouti<br/>et pourquoi, sans euphémisme"]
  O["Ce qui reste ouvert<br/>avec l'effort estimé"]
  P["Le périmètre suivant<br/>identifié, pas vendu"]
  A["L'ordre des auditoires<br/>les opérationnels, puis la direction"]

  click S "/notions/mesure-d-usage-produit"
  click E "/notions/redaction-technique"
  click O "/notions/roi-des-projets-ia"
  click P "/notions/bpmn"
