...
Niveau attendu : **référence**. Premier des deux domaines où l'ingénieur MLOps fait autorité : les deux portes que le ML ajoute à la chaîne n'ont pas d'autre gardien, et une chaîne toute verte qui promeut un modèle pire que le précédent ne se voit nulle part ailleurs dans l'organisation.
