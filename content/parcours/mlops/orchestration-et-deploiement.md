...
Niveau attendu : **autonomie**. Choisir entre bleu-vert, canari et ombre selon le risque réel, et revenir en arrière sans convoquer de réunion, se tient exactement à l'autonomie ; la référence revient au domaine qui juge après coup si le déploiement était bon — la supervision, page voisine.
