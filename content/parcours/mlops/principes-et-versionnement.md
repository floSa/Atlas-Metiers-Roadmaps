...
Niveau attendu : **autonomie**. Un confirmé met en place le versionnement des trois objets et rend une exécution reproductible sans qu'on le lui demande ; ce n'est pas un domaine de référence parce qu'il s'agit d'une discipline à tenir, pas d'un arbitrage technique que personne d'autre dans la salle ne saurait rendre.
