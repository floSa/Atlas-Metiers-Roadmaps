...
Niveau attendu : **usage**. Instrumenter des traces, plafonner un coût par requête, brancher un juge automatique : un confirmé le fait sur un chemin balisé ; la conception du jeu d'évaluation et des invites appartient à l'AI engineer, et c'est de ce côté-là que se trouve la référence.
