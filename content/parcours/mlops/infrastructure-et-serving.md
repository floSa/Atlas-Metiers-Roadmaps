...
Niveau attendu : **autonomie**. Un confirmé empaquette, dimensionne et débogue un service de prédiction sous pression, GPU compris ; le socle cloud et l'ordonnanceur appartiennent aux équipes plateforme, et l'embarqué reste à la notion tant qu'il n'est pas explicitement au périmètre de la mission.
