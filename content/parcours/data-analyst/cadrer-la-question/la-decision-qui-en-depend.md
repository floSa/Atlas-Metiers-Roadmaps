...
```mermaid
flowchart TD
  Q["Demande reçue"] --> D{"Et si le chiffre sort<br/>dans l'autre sens,<br/>que fais-tu ?"}
  D -->|"une action change"| E["Analyse engagée<br/>la précision se cale sur l'enjeu"]
  D -->|"rien ne change"| R["Demande renvoyée<br/>avec la question voisine qui, elle, sert"]
  E --> N["Niveau de rigueur<br/>proportionné à ce qui se décide"]
```
