...
Niveau attendu : **autonomie**. Concevoir le jeu d'évaluation, les traces et le budget par requête, puis défendre l'arbitrage coût/qualité qui en découle, est attendu d'un confirmé ; pas la référence, parce que la plateforme d'observabilité et son exploitation restent tenues par l'équipe qui l'opère.
