...
Niveau attendu : **autonomie**. Le problème n'ayant pas de solution au niveau du prompt, l'attendu est de concevoir la contre-mesure architecturale et de défendre un refus de périmètre — la référence, elle, est chez le red teamer et l'équipe sécurité, qu'on appelle tôt.
