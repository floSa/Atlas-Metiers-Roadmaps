...
Niveau attendu : **usage**. Deux ou trois paramètres comptent vraiment, leur documentation est publique et l'arbitrage réel se tranche dans le jeu d'évaluation et non dans le réglage : savoir s'en servir sur un chemin balisé suffit, et prétendre davantage serait de la superstition outillée.
