...
Niveau attendu : **autonomie**. L'attendu n'est pas de réciter le catalogue mais de trancher ce qui reste rentable sur un modèle à raisonnement, et de défendre ce choix devant quelqu'un qui brandit un article de 2023 — un arbitrage, donc, pas une récitation.
