...
```mermaid
flowchart TD
  U["Ce qu'on observe<br/>les arrêts, pas les commentaires"]
  P["Qui l'on fait venir<br/>et qui décide de ce qu'on en retient"]
  C["Ce qu'on en tire<br/>une reformulation du besoin"]
  T["Comparer deux versions<br/>quand l'observation ne tranche pas"]

  click U "/notions/mesure-d-usage-produit"
  click P "/notions/gestion-parties-prenantes"
  click C "/notions/cadrage-besoin"
  click T "/notions/ab-testing"
```
