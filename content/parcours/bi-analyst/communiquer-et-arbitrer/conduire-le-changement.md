...
```mermaid
flowchart LR
  E["Existant<br/>le tableur de la direction"] --> C["Coexistence<br/>un ou deux cycles"]
  C --> X["Écarts expliqués<br/>ligne par ligne si nécessaire"]
  X --> B["Bascule"]
  B -.->|"bascule d'autorité"| T["Tableur clandestin"]
```
